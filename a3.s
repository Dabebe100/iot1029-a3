...
_start:
    ...
    BGT greater_than // if R0 > R1, branch to the label 'greater_than'
    BLT lesser_than // if R0 < R1, branch to the label 'lesser_than'
    BEQ equal_to // if R0 == R1, branch to the label 'equal_to'
